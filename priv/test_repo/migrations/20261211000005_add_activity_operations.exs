defmodule Continuum.Test.Repo.Migrations.AddActivityOperations do
  use Ecto.Migration

  def up do
    alter table(:continuum_activity_tasks) do
      add(:lineage_id, :uuid)
      add(:parent_task_id, references(:continuum_activity_tasks, type: :uuid, on_delete: :nilify_all))
    end
